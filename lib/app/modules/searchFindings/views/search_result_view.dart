        ...
        child: ListView(
          ...
          children: [
            SearchBar(
              ...
              hintStyle: MaterialStateProperty.all<TextStyle>(const TextStyle(color: Colors.grey)),
              textStyle:
              ...
              trailing: [
                IconButton(
                  ...
                  onPressed: controller.searchFinding,
                ),
              ],
            ),
            ExpansionTile(
                              ...
                              itemBuilder: (BuildContext context, int i) {
                                return GestureDetector(
                                    ...
                                    child: FindingsCard(
                                      ...
                                      description: controller.searchedFindings[i].equipmentDescription,
